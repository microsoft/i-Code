...
from core.datasets import RvlCdipImageDataset, get_rvlcdip_labels
...
class ModelArguments:
    ...
    is_image_needed: bool = field(
        default=False,
        metadata={
            "help": "image information is needed or not."
        },
    )
    is_layout_needed: bool = field(
        default=False,
        metadata={
            "help": "layout information is added to text or not?."
        },
    )
    ...
    resnet_backbone: str = field(
        default="resnet50",
        metadata={
        "help": "CNN ResNet Backbone of the image Encoder"
        },
    )
...
def main():
   ...
   # Get datasets
    train_dataset = (RvlCdipDataset(data_args=data_args, tokenizer=tokenizer,
    ...
    eval_dataset = (RvlCdipDataset(data_args=data_args, tokenizer=tokenizer,
