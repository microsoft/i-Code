...
class CLAP(nn.Module):
    ...
    def encode_audio(self, audio, return_full_seq, device):
        return self.audio_branch(
            audio, return_full_seq=return_full_seq, mixup_lambda=None, device=device
    ...
    def get_audio_embedding(self, data, return_full_seq=False):
        ...
        audio_embeds = self.audio_projection(
            self.encode_audio(input_dict, return_full_seq=return_full_seq, device=device)["embedding"]
        )
