...
class DDPM(nn.Module):
    ...
    def register_schedule(self, given_betas=None, beta_schedule="linear", timesteps=1000,
        ...
        self.register_buffer('log_one_minus_ alphas_cumprod', to_torch(np.log(1. - alphas_cumprod)))
    ...
    def q_sample(self, x_start, t, noise=None):
        ...
        # print(x_start.device, t.device, self.sqrt_alphas_cumprod.device)
    ...
    def forward(self, x, *args, **kwargs):
        ...
        t = torch.randint(0, self.num_timesteps, (x.shape[0],), device=x.device).long().to(x.device)
...
class LatentDiffusion(DDPM):
    ...
    def p_losses(self, x_start, cond, t, noise=None):
        ...
        self.logvar = self.logvar.to(x_start.device)
